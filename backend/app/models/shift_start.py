...
class ShiftStart(Base):
    __tablename__ = "shift_starts"
    ...
    start_odo_gemini: Mapped[float | None] = mapped_column(nullable=True)
    start_soc_gemini: Mapped[float | None] = mapped_column(nullable=True)
